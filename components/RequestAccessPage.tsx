        ...
        <div className="flex items-center justify-center">
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-lg text-center">
                 ...
                 <p className="text-gray-600">
                    Thank you. Your request for access has been sent to the administrator for review.
                 </p>
      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-lg">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Fill out the form below to request access from an administrator.
          </p>
        </div>
        <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
             ...
             <div>
                <label htmlFor="clientId" className="block text-sm font-medium text-gray-700">Client ID (if known)</label>
             ...
             <div>
                <label htmlFor="note" className="block text-sm font-medium text-gray-700">Message</label>
                <textarea id="note" value={note} onChange={(e) => setNote(e.target.value)} rows={3} required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm" placeholder="Please provide a brief reason for your access request."></textarea>
            </div>
          <div>
            <button
              type="submit"
